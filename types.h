...
inline Ty_tyList Ty_TyList(Ty_ty head, Ty_tyList tail){
    return new Ty_tyList_{head,tail};
}
inline Ty_fieldList Ty_FieldList(Ty_field head, Ty_fieldList tail){
    return new Ty_fieldList_{head,tail};
}
