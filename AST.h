...
public:
    ...
    void EM_condition (bool condition, string message = "condition failed", bool fatal=false)    { ::EM_condition(condition,message, fatal,this->pos());  }
    ...
    // just for an example, not needed to compile
